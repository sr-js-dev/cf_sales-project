        ...
        return (
            ...
            <Modal.Body>
                <Row className="modal-header-doc">
                    ...
                    <Col sm={3} style={{textAlign:"center"}}>
                        <div style={{color: "#0D12EE", fontWeight:"bold"}}>{trls('Address')}:</div> 
                        {documentHeader[2]!=="null"&&(
                        <p style={{paddingTop:"10px"}}>{documentHeader[2]}</p>
                        )}
                    </Col >
                    <Col sm={3} style={{textAlign:"center"}}>
                        <div style={{color: "#0D12EE", fontWeight:"bold"}}>{trls('City')}:</div> 
                        {documentHeader[3]!=="null"&&(
                        <p style={{paddingTop:"10px"}}>{documentHeader[3]}</p>
                        )}
                    </Col>
                    <Col sm={3} style={{textAlign:"center"}}>
                        <div style={{color: "#0D12EE", fontWeight:"bold"}}>{trls('Country')}:</div> 
                        {documentHeader[4]!=="null"&&(
                        <p style={{paddingTop:"10px"}}>{documentHeader[4]}</p>
                        )}
                    </Col>
                </Row> 
